...
SET @sql_locations = IF(@locations_exists = 0, 'ALTER TABLE additional_information_questions ADD COLUMN locations JSON DEFAULT NULL COMMENT "JSON array of applicable locations (e.g., [\"Bath\", \"Devon\", \"Somerset\", \"Bristol\"])"', 'SELECT "Column locations already exists" as message');
...
UPDATE additional_information_questions SET locations = '["Bath", "Devon", "Somerset", "Bristol"]' WHERE locations IS NULL;
