                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="width:100%;">
                                <tr>
                                    <td style="padding:0; margin:0; line-height:0; font-size:0; width:100%;">
                                        ...
                                        <v:fill type="frame" src="${heroImageUrl}" color="#f3f4f6" />
                                        <w:anchorlock/>
                                        </v:roundrect>
                                        <![endif]-->
                                        <img src="${heroImageUrl}" alt="Fly Away Ballooning" width="640" style="width:100%; max-width:640px; height:auto; display:block; border-radius:24px 24px 0 0; border:0; outline:none; text-decoration:none; -ms-interpolation-mode:bicubic; background-color:#f3f4f6; vertical-align:top;" />
                                    </td>
                                </tr>
                            </table>
                        </td>
