 ...
 * `src/v21/batch_job_service_client_config.json`.
...
class BatchJobServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        if (opts.fallback) {
            ...
            lroOptions.httpRules = [{ selector: 'google.longrunning.Operations.CancelOperation', post: '/v21/{name=customers/*/operations/*}:cancel', body: '*', }, { selector: 'google.longrunning.Operations.DeleteOperation', delete: '/v21/{name=customers/*/operations/*}', }, { selector: 'google.longrunning.Operations.GetOperation', get: '/v21/{name=customers/*/operations/*}', }, { selector: 'google.longrunning.Operations.ListOperations', get: '/v21/{name=customers/*/operations}', }, { selector: 'google.longrunning.Operations.WaitOperation', post: '/v21/{name=customers/*/operations/*}:wait', body: '*', }];
        }
        this.operationsClient = this._gaxModule.lro(lroOptions).operationsClient(opts);
        const runBatchJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const runBatchJobMetadata = protoFilesRoot.lookup('.google.ads.googleads.v21.resources.BatchJob.BatchJobMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v21.services.BatchJobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.batchJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v21.services.BatchJobService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v21.services.BatchJobService, this._opts, this._providedCustomServicePath);
