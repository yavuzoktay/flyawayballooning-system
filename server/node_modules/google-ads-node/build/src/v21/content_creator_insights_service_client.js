 ...
 * `src/v21/content_creator_insights_service_client_config.json`.
...
class ContentCreatorInsightsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v21.services.ContentCreatorInsightsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.contentCreatorInsightsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v21.services.ContentCreatorInsightsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v21.services.ContentCreatorInsightsService, this._opts, this._providedCustomServicePath);
