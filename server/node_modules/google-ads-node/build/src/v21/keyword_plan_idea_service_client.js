 ...
 * `src/v21/keyword_plan_idea_service_client_config.json`.
...
class KeywordPlanIdeaServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v21.services.KeywordPlanIdeaService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keywordPlanIdeaServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v21.services.KeywordPlanIdeaService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v21.services.KeywordPlanIdeaService, this._opts, this._providedCustomServicePath);
     ...
     * @param {google.ads.googleads.v21.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork} request.keyword_planNetwork
     *   Targeting network.
